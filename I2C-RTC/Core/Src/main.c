...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define DS1307_ADDRESS 0xD0  // 0x68 << 1
...
// Set DS1307 time (call once)
void DS1307_SetTime(uint8_t year, uint8_t month, uint8_t date,
    ...
    data[4] = 0x01;  // Day of week (not used, set to 1)
    data[5] = Decimal_to_BCD(date);
